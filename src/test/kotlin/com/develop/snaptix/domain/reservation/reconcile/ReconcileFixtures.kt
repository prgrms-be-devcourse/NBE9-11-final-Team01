...
object ReconcileFixtures {
    ...
    fun insertUser(email: String = "user-${UUID.randomUUID()}@test.com"): Long =
        transaction {
            UsersTable.insert {
    ...
    fun insertEvent(status: EventStatus = EventStatus.ON_SALE): SeededEvent =
        transaction {
    ...
    fun findStatus(orderId: String): String =
        transaction {
            ReservationsTable
                .selectAll()
    ...
    fun countAudit(actionType: String): Long =
        transaction {
            AuditLogsTable
                .selectAll()
