    ...
    @ApiResponses(
        value = [
            ApiResponse(
                ...
                content = [Content(schema = Schema(implementation = EventBulkCreateResponse::class))],
            ),
            ApiResponse(
                responseCode = "400",
    ...
    @ApiResponses(
        value = [
            ApiResponse(
                ...
                content = [Content(schema = Schema(implementation = EventStatusUpdateResponse::class))],
            ),
            ApiResponse(
                responseCode = "400",
